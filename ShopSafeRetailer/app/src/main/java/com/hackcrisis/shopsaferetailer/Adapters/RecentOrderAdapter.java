...
import com.hackcrisis.shopsaferetailer.OrderViewActivity;
...
public class RecentOrderAdapter extends RecyclerView.Adapter<RecentOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        databaseReference.child("users").child(order.getUserId()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                holder.userNameTv.setText("Placed by : " + dataSnapshot.child("userName").getValue(String.class));
            }
